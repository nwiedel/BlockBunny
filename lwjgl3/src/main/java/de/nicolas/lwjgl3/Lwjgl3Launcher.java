...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(new BlockBunnyGame(), getDefaultConfiguration());
    }
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setWindowedMode(GameConfig.V_WIDTH * GameConfig.SCALE,
            GameConfig.V_HEIGHT * GameConfig.SCALE);
